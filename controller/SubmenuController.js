...
const submenu = async (req, res) => {
    try {
        const submenu = await SubmenuModel.getAllSubmenuWithMenu(req.db)
...
const store = async (req, res) => {
    try {
        ...
        await SubmenuModel.insertSubmenu({ name, route, menu_id: id_menu, order }, req.db)
...
const update = async (req, res) => {
    try {
        ...
        const detailSubmenu = await SubmenuModel.getSubmenuByID(id_submenu, req.db)
...
const destroy = async (req, res) => {
    try {
        ...
        await SubmenuModel.deleteSubmenuByID(id_submenu, req.db)
